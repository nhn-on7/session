...
import com.nhnacademy.marketgg.auth.aop.RedisSessionAspect;
...
public class RedisSessionConfig {
    ...
    @Bean
    public RedisSessionAspect redisSessionAspect(RedisTemplate<String, RedisSession> redisTemplate) {
        return new RedisSessionAspect(redisTemplate);
    }
